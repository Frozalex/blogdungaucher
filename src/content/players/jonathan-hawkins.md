...
iconicGame:
  ...
  keyMoments:
    - "Échange volontaire vers une structure saine, sans contre-jeu."
    - "Petites améliorations: une pièce, puis une autre, sans se presser."
    - "L’adversaire craque sur un détail (un pion faible, une case)."
    - "Finale convertie “comme un protocole”."

tags: ["angleterre", "finales", "progression", "discipline", "endgame"]
seoTitle: "Jonathan Hawkins : progression, finales, leçons utiles | Blog d'un Gaucher"
seoDescription: "Portrait de Jonathan Hawkins : psychologie, méthode de progression, contribution pédagogique, une partie emblématique commentée simplement et les leçons concrètes pour progresser."
---
...
1. **Entrée volontaire dans une structure saine**: pas de complication gratuite, mais une position où les plans sont clairs.
2. **Amélioration des pièces**: Hawkins refuse la précipitation. Il place ses pièces sur leurs meilleures cases, même si ça a l’air lent.
3. **Ciblage d’un détail**: un pion isolé, une case faible, une tour passive.
