...
iconicGame:
  title: "Une défense qui retourne la pression"
  keyMoments:
    - "Harikrishna accepte une position légèrement inférieure, mais sans danger."
    - "Il échange ce qui donne du jeu à l’adversaire."
    - "Il améliore une pièce passive et “respire”."
    - "L’adversaire force… et crée sa propre faiblesse."
    - "La partie se renverse sans coup spectaculaire."

tags: ["inde", "stabilite", "defense", "precision", "top10"]
seoTitle: "Pentala Harikrishna : style, psychologie, leçons | Blog d'un Gaucher"
seoDescription: "Portrait de Pentala Harikrishna : psychologie du joueur, contribution aux échecs indiens, une partie emblématique commentée simplement et les leçons à appliquer."
---
...
1. **Il accepte une petite pression**. Pas par faiblesse, mais parce qu’il sait que la pression n’est pas encore une menace.
2. **Il élimine le contre-jeu**. Il échange les pièces qui donnent de l’initiative à l’adversaire.
3. **Il améliore la coordination**. Un coup “tranquille” qui rend soudain la position plus simple à défendre.
4. **L’adversaire force**. Et c’est là que le match commence vraiment: forcer, c’est souvent créer une faiblesse.
5. **Renversement**. Pas un sacrifice. Un changement de nature: la pression change de camp.
