...
1. **Développement rapide** : pas de coups décoratifs.
2. **Menaces concrètes** : viser le centre/roi, pas “faire du bruit”.
3. **Transition** : si l’attaque n’existe pas, on bascule vers une finale active.
