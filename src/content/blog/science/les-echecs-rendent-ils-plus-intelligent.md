...
keyTakeaways:
  ...
  - "L'effet placebo et le biais d'attente expliquent une part importante des résultats positifs publiés."
  - "Les échecs développent des compétences réelles, mais surtout dans le contexte des échecs : concentration, mémoire des positions, anticipation tactique."
  - "Le vrai bénéfice des échecs n'est pas d'augmenter le QI, mais d'offrir un terrain d'entraînement pour la patience, la défaite et la rigueur."
faq:
  - question: "Les échecs augmentent-ils vraiment le QI ?"
    answer: "Les méta-analyses récentes (Sala & Gobet, 2017) trouvent un effet faible sur la cognition générale, et cet effet disparaît presque entièrement quand on contrôle pour le biais d'attente. Pratiquer les échecs ne fait pas monter le QI de manière significative chez les adultes."
  - question: "Pourquoi entend-on alors que les échecs développent l'intelligence ?"
    answer: "Parce que c'est une idée séduisante, défendue par des fédérations et des programmes éducatifs qui ont intérêt à la promouvoir. Les études favorables sont souvent mal contrôlées (pas de groupe placebo), ce qui gonfle artificiellement les bénéfices observés."
...
## D'où vient l'idée que les échecs rendent intelligent

L'association entre échecs et intelligence est ancienne. Les premiers traités russes du XIXe siècle parlaient déjà du jeu comme d'une « gymnastique de l'esprit ». Puis au XXe siècle, les écoles soviétiques en ont fait un outil pédagogique massif, partant du principe qu'un peuple meilleur aux échecs serait un peuple plus rationnel.
...
Le tournant a eu lieu avec les travaux de [Giovanni Sala et Fernand Gobet](https://en.wikipedia.org/wiki/Fernand_Gobet), publiés notamment dans *Educational Research Review* en 2017. Ils ont agrégé 24 études impliquant plus de 2 700 enfants et adolescents pour évaluer rigoureusement le transfert cognitif des échecs.

Le résultat est gênant pour la doxa : l'effet global est faible (taille d'effet g ≈ 0.34) et surtout, il diminue fortement quand on prend en compte la qualité méthodologique des études. Quand un groupe placebo actif (autre activité structurée) est inclus, l'effet spécifique des échecs s'effondre.

En 2019, une seconde méta-analyse encore plus stricte a confirmé : les bénéfices spécifiques des échecs sur la cognition générale sont *quasi nuls* une fois contrôlés les effets de l'attente et de la motivation.
...
Une autre explication des résultats positifs publiés est ce qu'on appelle l'**effet d'attente** : quand les chercheurs, les enseignants ou les enfants eux-mêmes croient que l'activité va produire un effet, cet effet se produit en partie *parce qu'il est attendu*.
...
Soyons honnêtes : dire que les échecs n'augmentent pas le QI ne veut pas dire qu'ils ne servent à rien. Ils développent des compétences réelles, mais il faut les nommer correctement.
...
Si la science est si claire, pourquoi la croyance reste-t-elle aussi forte ? Plusieurs raisons :
...
Faut-il arrêter d'enseigner les échecs aux enfants ? Surtout pas. Mais il faut changer le discours.

Arrêter de promettre une amélioration du QI, des notes en maths ou des capacités de raisonnement abstrait. Promettre plutôt : un terrain d'entraînement pour la patience, l'attention longue, la défaite, l'analyse de soi.

Ces qualités-là ne sont pas mesurables au QI. Elles sont précieuses pour d'autres raisons. Et elles méritent qu'on les défende pour ce qu'elles sont, pas en se cachant derrière des promesses que la science ne valide pas.
