...
- R_A = 1600, R_B = 1800
- $P = \frac{1}{1+10^{0{,}5}} \approx \frac{1}{4{,}16} \approx 0{,}24$ → A a 24% de chances
...
- A gagne contre B (résultat inattendu) : $R'_A = 1600 + 16 \times (1 - 0{,}24) = 1600 + 12 = 1612$
...
- [ ] Lire l'article de fond [Grand oral spé Maths](/fr/blog/grand-oral-maths-spe-echecs/)
