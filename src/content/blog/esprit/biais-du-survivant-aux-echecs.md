---
title: "Le biais du survivant aux échecs : le cimetière que tu ne vois pas"
excerpt: >-
...
tags:
  ...
  - statistiques
  - échecs
seoTitle: "Biais du survivant aux échecs : ouvertures, conseils de GM et prodiges"
seoDescription: >-
  Le biais du survivant appliqué aux échecs : pourquoi la théorie des ouvertures, les conseils de grands
  maîtres et les histoires de prodiges décrivent tous un échantillon dont les perdants ont disparu.
faq:
  - question: "Qu'est-ce que le biais du survivant ?"
    answer: >-
      C'est l'erreur qui consiste à tirer des conclusions à partir des seuls éléments qui ont franchi un
      filtre, en oubliant ceux que le filtre a éliminés parce qu'ils sont, par construction, invisibles.
      L'illustration classique vient des travaux du statisticien Abraham Wald en 1943 sur les avions
      revenus de mission : les impacts qu'on observe sur les rescapés indiquent où un avion peut encaisser
      des dégâts, pas où il est vulnérable.
  - question: "En quoi la théorie des ouvertures est-elle biaisée par les survivants ?"
    answer: >-
      Parce qu'elle se construit sur les parties qui entrent dans les bases : essentiellement des parties
      de tournoi entre joueurs classés, publiées et annotées. Les positions qui ne mènent nulle part ne
      produisent pas de parties célèbres, donc pas d'analyse, donc pas de théorie. L'absence d'une ligne
      dans la théorie signifie rarement qu'elle a été réfutée : le plus souvent, elle signifie que
      personne n'a eu de raison de la publier.
  - question: "Pourquoi mon gambit marche-t-il si bien alors qu'il est réputé douteux ?"
    answer: >-
      Parce que tu observes un échantillon filtré. Les parties où le gambit a produit une attaque
      spectaculaire sont mémorables et se racontent. Celles où l'adversaire a accepté, rendu le matériel
      au bon moment et gagné une finale terne ne se racontent pas. Le taux de réussite que tu perçois
      est celui de tes souvenirs, pas celui de ta base de données.
  - question: "Le cas des sœurs Polgar prouve-t-il que l'entraînement suffit ?"
    answer: >-
      Non, pour deux raisons. D'abord parce qu'un protocole sans groupe témoin et sans réplication ne
      permet pas de conclure. Ensuite parce que le résultat lui-même est plus nuancé qu'on ne le dit :
      Robert Howard a montré en 2011 que malgré un entraînement comparable, les trois sœurs n'ont pas
      atteint le même niveau. Toutes les familles ayant tenté une démarche similaire sans succès n'ont
      jamais fait l'objet d'un livre.
  - question: "Comment se protéger du biais du survivant quand on progresse aux échecs ?"
    answer: >-
      En cherchant systématiquement l'échantillon complet plutôt que les cas remarquables. Concrètement :
      consulter le pourcentage réel dans une base de données plutôt que se fier à l'impression, tenir un
      journal de toutes les parties et pas seulement des marquantes, et se demander devant chaque conseil
      de joueur fort combien de personnes l'ont appliqué sans que cela fonctionne.
---
...
Pendant la Seconde Guerre mondiale, le [Statistical Research Group](https://fr.wikipedia.org/wiki/Biais_du_survivant) de l'université Columbia travaille pour l'armée américaine. Parmi ses membres, un mathématicien d'origine hongroise, [Abraham Wald](https://fr.wikipedia.org/wiki/Abraham_Wald).
...
Le débat de fond entre inné et acquis est traité dans notre article sur [génétique et talent aux échecs](/fr/blog/echecs-et-genetique/). Ce qui nous occupe ici est plus étroit : même l'exemple invoqué pour prouver la thèse ne la prouve pas, et l'échantillon qui permettrait de trancher est invisible par construction.
...
**Tiens le registre complet.** Note toutes tes parties, y compris les nulles insipides et les défaites sans histoire. Un carnet qui ne contient que les parties marquantes finit par décrire un joueur qui n'existe pas. C'est le principe de base d'une [analyse de parties utile](/fr/blog/analyser-ses-parties/).
...
*Cet article fait partie d'une série sur la psychologie appliquée aux échecs. Voir aussi [l'effet Dunning-Kruger aux échecs](/fr/blog/effet-dunning-kruger-aux-echecs/) et [la dissonance cognitive aux échecs](/fr/blog/dissonance-cognitive-aux-echecs/).*
