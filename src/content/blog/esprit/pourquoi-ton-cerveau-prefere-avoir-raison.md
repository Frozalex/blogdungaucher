---
title: "Pourquoi ton cerveau préfère avoir raison plutôt qu'apprendre"
excerpt: >-
...
tags:
  ...
  - progression
  - échecs
seoTitle: "Pourquoi ton cerveau préfère avoir raison au lieu d'apprendre"
seoDescription: >-
  La synthèse d'une série de 41 articles sur la psychologie aux échecs : la chaîne des six mécanismes
  qui protègent ton image de toi, et la seule parade qui fonctionne.
faq:
  - question: "Pourquoi préfère-t-on avoir raison plutôt qu'apprendre ?"
    answer: >-
      Parce que ce n'est pas la même dépense. Maintenir une image de soi cohérente est rapide,
      automatique et gratuit ; réviser cette image est lent, coûteux et désagréable. Le système ne
      fonctionne pas mal : il optimise autre chose que l'exactitude, à savoir la stabilité du modèle
      qu'on a de soi.
  - question: "Quels mécanismes interviennent après une défaite aux échecs ?"
    answer: >-
      Ils s'enchaînent dans un ordre régulier. La dissonance produit l'inconfort, la rationalisation
      fournit une explication en moins de trois minutes, les mécanismes de défense absorbent le reste,
      et la mémoire reconstructive normalise progressivement le souvenir vers l'idée que tu te fais de
      ton jeu.
  - question: "Pourquoi les échecs sont-ils un terrain particulier pour ces mécanismes ?"
    answer: >-
      Parce que la défaite y est sans ambiguïté, sans coéquipier à qui l'attribuer, sans part de
      hasard, publique, chiffrée et fréquente. C'est l'une des rares activités humaines qui produisent
      en continu des preuves susceptibles de contredire l'image qu'on a de soi.
  - question: "Quelle est la parade la plus efficace ?"
    answer: >-
      Écrire avant. C'est la conclusion qui revient dans presque tous les articles de cette série sans
      avoir été cherchée : évaluation avant le moteur, coups envisagés avant l'analyse, explication
      avant l'examen des faits, critère d'abandon avant l'investissement. Aucun de ces mécanismes ne
      peut modifier une note antérieure.
  - question: "Faut-il se méfier de toutes les études citées en psychologie ?"
    answer: >-
      Il faut leur demander la même chose qu'à soi-même : une trace antérieure. Beaucoup de classiques
      présentés dans cette série n'ont pas survécu à des réplications rigoureuses. Ce qui a le mieux
      tenu, ce sont les protocoles préenregistrés et les mesures indépendantes du jugement du sujet.
---

Un moteur affiche une évaluation qui contredit la tienne. Tu as deux secondes pour décider ce que tu vas faire de cette information.

La première voie est rapide. Elle consiste à comprendre pourquoi le moteur dit ça, à intégrer la variante, à te dire que tu avais vu l'idée mais mal évalué la suite, puis à passer à la partie suivante. Elle coûte trente secondes et elle ne modifie rien en toi.
...
Maintenir une image de soi cohérente est rapide, automatique, gratuit, et procure un soulagement immédiat. Réviser cette image demande du temps, de l'attention, une tolérance à l'inconfort, et ne procure aucune récompense avant plusieurs semaines.

Face à un tel écart de coût, il n'y a rien d'étonnant à ce que le système choisisse systématiquement la première option. Il ne dysfonctionne pas. **Il optimise autre chose que l'exactitude.**
...
En reprenant les quarante articles précédents, un ordre apparaît. Ces mécanismes ne sont pas une collection de biais indépendants : ils s'enclenchent en séquence, chacun couvrant le moment que le précédent n'atteint pas.

### Avant : l'angle mort structurel

Tout commence par une impossibilité.

L'effet décrit par Kruger et Dunning n'est pas que les faibles se croient forts. C'est que **les compétences qui permettent de bien faire une chose sont les mêmes que celles qui permettent de juger si on la fait bien**. Quand elles manquent, elles manquent deux fois.
...
Et pendant que la recherche est orientée, la [projection](/fr/blog/projection-aux-echecs/) remplit les cases manquantes. Modéliser l'esprit de l'adversaire est coûteux ; en l'absence d'effort explicite, le système le remplit avec ton propre contenu. Tu supposes qu'il a vu ce que tu as vu, et qu'il n'a pas vu ce que tu n'as pas vu.

### Au moment du résultat : l'inconfort
...
### Trois minutes après : l'explication
...
Il faut rappeler ici que ce modèle est fragile : le DSM-5 a retiré l'échelle de fonctionnement défensif présente en annexe du DSM-IV, notamment par insuffisance de soutien empirique. Il reste une typologie descriptive utile, pas un système causal validé.

### Sur des années : la normalisation

Le dernier mécanisme est le plus lent et probablement le plus décisif.

La [mémoire reconstructive](/fr/blog/memoire-reconstructive-aux-echecs/) ne relit pas un enregistrement : elle refabrique. Et Bartlett a montré que cette reconstruction n'est pas aléatoire : elle se normalise vers le schéma de celui qui se souvient.

Ton schéma, ici, c'est l'idée que tu te fais de ton jeu. Chaque fois que tu te souviens d'une partie, les éléments qui n'y cadrent pas s'effacent un peu. Au bout de quelques années, tu disposes d'un corpus de souvenirs remarquablement cohérent, décrivant un joueur qui n'existe pas.

Et comme tu construis ton entraînement à partir de cette image, la boucle se referme : le schéma déforme les souvenirs, les souvenirs confirment le schéma.
...
Autrement dit, ce jeu produit en continu des preuves susceptibles de contredire l'image que tu as de toi, dans des conditions qui interdisent presque toutes les échappatoires ordinaires.
...
Et le coût est dérisoire : dix secondes, une ligne, avant. Comparé à tout ce que cette série a décrit, c'est la meilleure affaire disponible.

## Quand avoir raison est la bonne stratégie
...
C'est précisément ce qu'une trace écrite antérieure permet de faire. Elle ne te force pas à réviser : elle te donne les moyens de savoir si tu aurais dû.
...
Autrement dit, la recherche a résolu son problème de la même façon que celle proposée ici : en écrivant ce qu'elle attendait **avant** de regarder.

Ce n'est pas une coïncidence. C'est le même problème, à deux échelles.
...
L'argument en faveur de l'apprentissage n'est donc pas qu'il serait plus vertueux. Il est que **ses effets s'accumulent et que ceux d'avoir raison ne s'accumulent pas**.
...
Ton cerveau ne préfère pas avoir raison par orgueil. Il le préfère parce que maintenir une image de soi cohérente est rapide et gratuit, tandis que la réviser est lent et douloureux. Le système ne dysfonctionne pas : il optimise la stabilité plutôt que l'exactitude, et cette stabilité est ce qui te permet de rejouer demain.

Six mécanismes s'en chargent, dans un ordre régulier. Un angle mort qui t'empêche de voir ce qui te manque. Une recherche orientée pendant le calcul. Une projection qui comble les vides avec ton propre contenu. Un inconfort au moment du résultat. Une explication en moins de trois minutes. Et une normalisation lente du souvenir vers ce que tu crois déjà.
...
*Cet article est le hub d'une série de 41 textes sur la psychologie appliquée aux échecs. Il referme les six articles du noyau : [Dunning-Kruger](/fr/blog/effet-dunning-kruger-aux-echecs/), [la dissonance cognitive](/fr/blog/dissonance-cognitive-aux-echecs/), [le biais de confirmation](/fr/blog/biais-de-confirmation-aux-echecs/), [les mécanismes de défense](/fr/blog/mecanismes-de-defense-aux-echecs/), [la rationalisation](/fr/blog/rationalisation-aux-echecs/) et [la projection](/fr/blog/projection-aux-echecs/). Voir [l’index complet de la série](/fr/series/psychologie/).*
