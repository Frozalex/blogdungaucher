...
Si les grands maîtres n'ont pas une mémoire globale extraordinaire, comment font-ils pour jouer à l'aveugle contre dix adversaires ou se souvenir d'une partie jouée il y a vingt ans ? La réponse s'appuie sur les travaux de [Fernand Gobet](https://fr.wikipedia.org/wiki/Fernand_Gobet), chercheur à l'Université de Liverpool, et de [Herbert Simon](https://fr.wikipedia.org/wiki/Herbert_Simon), prix Nobel d'économie.

Gobet & Simon ont estimé qu'un joueur professionnel stocke dans sa mémoire à long terme entre **50 000 et 300 000 "chunks"** (ou "templates"), c'est-à-dire des blocs de configurations de pièces déjà rencontrées (mécanisme analysé en détail dans [Échecs et mémoire](/fr/blog/echecs-et-memoire/)). Les expériences fondatrices d'[Adriaan de Groot](https://fr.wikipedia.org/wiki/Adriaan_de_Groot) dans les années 1940 avaient déjà montré que si tu présentes les mêmes pièces dans des positions aléatoires (hors d'une partie réelle), l'avantage mémoriel des experts disparaît presque entièrement. Leur mémoire n'est pas "meilleure" en absolu : elle est **organisée** autour de patterns signifiants.
...
[Magnus Carlsen](https://fr.wikipedia.org/wiki/Magnus_Carlsen) a passé un scanner en 2015 dans le cadre d'un projet documentaire norvégien. Résultat : un cerveau normal, sans architecture particulière. Rien qui distingue un Champion du Monde d'un comptable de Bergen.
...
## FAQ sur les échecs et le cerveau
...
La recherche ne fixe pas de seuil universel. Les changements comportementaux (fonctions exécutives) apparaissent après **10 à 12 semaines** d'entraînement régulier (Dania 2021 ; Ramos 2017). Les changements structurels (IRM) nécessitent des années de pratique intensive et sont corrélés à l'âge de début (Trevisan 2022, ρ = −0,54).
