...
excerpt: >-
  Grand Oral spécialité SES ou HGGSP avec les échecs : méthodologie de l'épreuve, script minuté 10 min,
  données économiques et géopolitiques, 25 questions de jury rédigées. Fischer-Spassky comme guerre froide,
  Bourdieu et capital culturel, Chess for Refugees : tout y est.
...
keyTakeaways:
  ...
  - 25 questions de jury avec réponses complètes citant des auteurs (Bourdieu, Sen, Nye) et faits documentés.
  - Fiches mémo auteurs-concepts et données clés à imprimer pour le jour J.
...
faq:
  - question: Peut-on faire un Grand Oral SES avec les échecs sans être joueur ?
    answer: >-
      ...
      professionnels), capital culturel (Bourdieu), influence culturelle (Fischer-Spassky et la guerre froide),
      inégalités d'accès à la culture. Tu n'as pas besoin de savoir jouer aux échecs pour réussir un excellent exposé.
  ...
  - question: Comment mobiliser HGGSP avec les échecs ?
    answer: >-
      ...
      instrument d'influence américain pendant la guerre froide ; (2) thème 'Histoire et mémoire', comment le match de
      1972 est mémorisé différemment en URSS et aux USA ; (3) thème 'Mondialisation', les échecs comme lingua franca
      internationale, homogénéisation et résistances culturelles ; (4) thème 'Patrimoine', l'inscription des échecs au
...
1. **Il mobilise au moins deux concepts** du **programme** (capital culturel, marché, influence, **mémoire**…)
2. **Il s'appuie sur des données chiffrées** ou des **exemples** documentés
3. **Il permet une nuance critique** : pas une thèse univoque
