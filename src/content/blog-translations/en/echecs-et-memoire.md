...
This result, published in 1973 by [William Chase](https://en.wikipedia.org/wiki/William_Chase_(psychologist)) and [Herbert Simon](https://en.wikipedia.org/wiki/Herbert_A._Simon) in *Cognitive Psychology*, overturned the idea that chess champions had photographic memory or off-scale intelligence. What they have is more precise: a library.
...
Chase and Simon did not appear in a vacuum. They build on a pioneering thesis by [Adriaan de Groot](https://en.wikipedia.org/wiki/Adriaan_de_Groot), Dutch psychologist and master-strength player, published in English as *Thought and Choice in Chess* in 1965.
...
[George Miller](https://en.wikipedia.org/wiki/George_Armitage_Miller) showed in 1956 that working memory capacity (how much information you can manipulate at once) is about seven items for most people. Plus or minus two. Not fifty. Not one hundred. Seven.
...
That principle, which [Anders Ericsson](https://en.wikipedia.org/wiki/K._Anders_Ericsson), theorist of deliberate practice, documented across domains, holds here too. An experienced musician does not retain a score note by note; they retain phrase by phrase, section by section. A grandmaster does not calculate square by square; they think in structures.

[Neuroimaging](https://en.wikipedia.org/wiki/Neuroimaging) studies confirm the shift: experienced players activate long-term memory areas (hippocampus, dorsolateral prefrontal cortex) more and "pure" working-memory zones less when recognising positions. Their brain does not store more; it sorts better. That evolution of brain geography under practice is described in detail in the article on [chess and the brain](/en/blog/les-echecs-et-le-cerveau/).
...
[Ericsson](https://en.wikipedia.org/wiki/K._Anders_Ericsson) often cited chess studies to illustrate this: gains in domain-specific memory come from reflective practice, not raw volume. The distinction between "playing" and "training" is exactly there.

The same mechanism explains why some cognitive profiles, those who naturally recognise visual patterns, find chess especially suited to their information-processing style. That is explored in depth in the article on [chess and autism](/en/blog/echecs-et-autisme/).
...
**Does playing chess improve general memory?**

Research is nuanced: benefits are mostly domain-specific. Memory for chess positions improves. Transfer to other memory forms is possible but modest and not guaranteed. By contrast, mechanisms of information compression (chunking applied elsewhere) can improve if practice is reflective.

**How many patterns do you need for a solid club level?**

de Groot estimated a master holds 50,000 to 100,000 chunks. A solid club level (around 1500 Elo) likely requires hundreds to a few thousand well-consolidated templates on endgames and main tactical themes.

**Do children memorise positions more easily than adults?**

Children often learn faster in absolute terms, helped by childhood brain plasticity. But [Neil Charness](https://www.researchgate.net/profile/Neil-Charness)'s studies show motivated adults build chunks just as effectively, perhaps more slowly but still reliably. Age does not close the library.

**Does fast chess (blitz) build chunks too?**

Partly. Blitz exposes you to many patterns quickly, which can build visual familiarity. But neuroimaging work suggests deep analysis, slow chess with conscious reflection, is what durably consolidates templates in long-term memory.
...
- **Gobet, F., & Simon, H. A. (1996).** - [*Templates in chess memory: A mechanism for recalling several boards.*](https://doi.org/10.1006/cogp.1996.0011) *Cognitive Psychology*, 31(1), 1-40. (Extension of chunk theory: templates manage complex positions via flexible cognitive structures with fixed core and variable slots.)
- **Miller, G. A. (1956).** - [*The magical number seven, plus or minus two: Some limits on our capacity for processing information.*](https://doi.org/10.1037/h0043158) *Psychological Review*, 63(2), 81-97. (Working-memory capacity is universally limited to ~7 items; chunking is how expertise sidesteps the limit.)
