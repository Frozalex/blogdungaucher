---
title: "A dissonância cognitiva no xadrez: por que você diz \"eu estava ganhando\""
excerpt: >-
  Perder cria um desconforto mental que o cérebro tenta apagar o mais rápido possível. Na maioria das
  vezes, ele não apaga a derrota: apaga o que ela significa. É assim que nasce a frase mais dita
  depois de uma partida de xadrez.
seoTitle: "Dissonância cognitiva no xadrez: a psicologia do \"eu estava ganhando\""
seoDescription: >-
  A dissonância cognitiva explicada pelo xadrez: por que dizemos "eu estava ganhando", por que nos
  apegamos a uma abertura estudada, e o que a replicação de 2024 mudou na teoria.
frSlug: dissonance-cognitive-aux-echecs
tags:
  ...
  - xadrez
faq:
  - question: "O que é a dissonância cognitiva?"
    answer: >-
      É o desconforto sentido quando dois elementos de conhecimento são incompatíveis, por exemplo "eu
      sou um bom jogador" e "acabei de perder de bobeira". Leon Festinger propôs essa teoria em 1957. A
      ideia central dele é que esse desconforto empurra a pessoa a agir para reduzi-lo, e que o caminho
      mais curto raramente passa por questionar a imagem de si mesmo.
  - question: "Por que a gente diz \"eu estava ganhando\" depois de uma derrota?"
    answer: >-
      Porque muitas vezes é verdade, e é isso que torna a frase tão eficaz. Ela reduz a dissonância sem
      mentir. O problema não é a exatidão dela, é o que ela permite não examinar: por que você não
      converteu. Uma posição ganha não convertida é uma informação sobre o seu nível, não uma
      circunstância atenuante.
  - question: "Por que é tão difícil abandonar uma abertura que a gente estudou?"
    answer: >-
      Por causa da justificativa do esforço, um efeito demonstrado por Aronson e Mills em 1959: quanto
      mais caro custou o acesso a alguma coisa, mais valor se atribui a ela. As horas investidas num
      repertório não deixam esse repertório melhor, mas tornam o abandono dele caro psicologicamente. A
      pessoa deixa de defender a abertura e passa a defender o investimento.
  - question: "A teoria da dissonância cognitiva ainda é válida?"
    answer: >-
      Ela é sólida como descrição, mais frágil como mecanismo experimental. Em 2024, uma replicação
      feita em 39 laboratórios de 19 países com quase 4 900 participantes não reencontrou o efeito
      central do paradigma histórico. Os pesquisadores concluem que esse paradigma não fornece prova
      robusta da dissonância. Que as pessoas reduzam o desconforto reinterpretando os fatos continua
      amplamente documentado por outras vias.
  - question: "Como evitar a dissonância cognitiva depois de uma derrota no xadrez?"
    answer: >-
      Não dá para evitar, ela é automática. Dá, por outro lado, para atrasar a resolução dela. A regra
      mais eficaz é separar no tempo o momento da derrota e o momento da análise: anote a posição e os
      fatos no calor da hora, sem conclusão, e analise a frio vinte e quatro horas depois. A redução de
      dissonância opera principalmente nos minutos seguintes.
---
...
Em 1957, [Leon Festinger](https://pt.wikipedia.org/wiki/Leon_Festinger) publica *A Theory of Cognitive Dissonance*. A proposta cabe numa frase: quando dois elementos de conhecimento são incompatíveis, essa incompatibilidade produz um **estado de desconforto**, e esse desconforto tem uma força motivacional própria. Ele empurra a pessoa a agir, exatamente como a fome ou a sede.
...
Você não está mais defendendo a abertura. Está defendendo o investimento. É o mesmo mecanismo que torna tão difícil largar um curso que se pagou caro, e é um primo bem próximo da falácia dos custos afundados. O nosso artigo sobre [é mesmo preciso estudar aberturas](/pt-br/blog/faut-il-vraiment-etudier-les-ouvertures/) trata da questão por outro ângulo.
