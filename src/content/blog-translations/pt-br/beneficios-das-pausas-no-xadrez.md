---
title: "Os benefícios das pausas no xadrez: por que parar de jogar te torna melhor"
excerpt: >-
  Jogar menos para progredir mais: parece absurdo, mas a ciência da recuperação cognitiva explica por que as
  pausas regulares são uma das práticas mais subestimadas do jogador de xadrez sério.
seoTitle: "Pausas no xadrez: por que parar te torna melhor jogador"
seoDescription: "Por que as pausas melhoram o xadrez: consolidação da memória, fadiga cognitiva, sono e rage-quit. Protocolos concretos para torneios e treinos."
frSlug: bienfaits-des-pauses-aux-echecs
---
...
Quando você trabalha num problema tático ou joga uma partida complexa, os neurônios envolvidos formam novas conexões e reforçam as existentes. Mas essa consolidação é um processo em dois tempos. O primeiro é a codificação, que ocorre durante a prática. O segundo é a [consolidação sináptica](https://pt.wikipedia.org/wiki/Consolida%C3%A7%C3%A3o_da_mem%C3%B3ria), que ocorre depois, durante o repouso e particularmente durante o sono.

A pesquisa sobre [consolidação da memória procedural](https://pt.wikipedia.org/wiki/Mem%C3%B3ria_procedural) mostrou que competências aprendidas logo antes de uma noite de sono são mais bem retidas do que as mesmas competências aprendidas sem consolidação pelo sono depois. Esse efeito é robusto em muitos domínios, da música à cirurgia.
...
A [fadiga cognitiva](https://pt.wikipedia.org/wiki/Fadiga_mental) é o estado de declínio das performances mentais que resulta de um período prolongado de atividade intelectual intensa. Não é idêntica à fadiga física, mas é igualmente real.
...
Uma micropausa é uma interrupção curta (5 a 15 minutos) de uma sessão de trabalho ou jogo. A [pesquisa sobre micropausas](https://pubmed.ncbi.nlm.nih.gov/23587718/) em contextos de trabalho cognitivo intensivo demonstrou sua eficácia para manter a qualidade da atenção em sessões longas.

A razão neurológica está ligada à [rede padrão](https://pt.wikipedia.org/wiki/Rede_de_modo_padr%C3%A3o) do cérebro: quando você para de focalizar a atenção numa tarefa, essa rede se ativa. Ela está envolvida no processamento interno, na integração de informações e na criatividade. Pausas curtas ativam essa rede e permitem uma espécie de "digestão" das informações processadas durante o período de trabalho anterior.
...
Estudos sobre aprendizado motor e cognitivo mostram que o espaçamento entre repetições afeta a qualidade da consolidação. Um espaçamento razoável entre as sessões de prática produz aprendizados melhores a longo prazo do que um acúmulo denso num curto período. É o que se chama de [efeito de espaçamento](https://pt.wikipedia.org/wiki/Efeito_do_espa%C3%A7amento) ou spaced practice.

## O sono como ferramenta de treino

Se as micropausas são úteis durante a sessão, o sono é a pausa mais poderosa disponível. A pesquisa sobre [sono e memória](https://pt.wikipedia.org/wiki/Sono_e_mem%C3%B3ria) se desenvolveu consideravelmente nas últimas duas décadas.
