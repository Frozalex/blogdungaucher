...
excerpt: >-
  ...
  Retrato psicológico de um jogador diante de si mesmo.
...
faq:
  - question: "Como lidar com o tilt no xadrez?"
    answer: >-
      A regra mais eficaz segundo os treinadores, entre eles Mark Dvoretsky: parar de jogar assim que o tilt
      começa, não depois. A análise pós-partida feita a frio, procurando o estado emocional no momento do erro,
      e não só o erro técnico, é a melhor ferramenta de desarme no longo prazo. Identificar que tipo de situação
      dispara o seu tilt (sacrifício mal calculado, surpresa na abertura, zeitnot) te dá um plano de treino concreto.
  - question: "Por que jogamos pior sob pressão de tempo?"
    answer: >-
      O zeitnot ativa um mecanismo documentado pelos psicólogos: a paralisia por análise. O cérebro procura a
      resposta perfeita em vez de uma boa resposta rápida, gasta tempo, e o pânico se instala em espiral (Kahneman,
      Sistema 2 em sobrecarga). A solução não é calcular mais rápido: é confiar mais cedo no julgamento posicional
      já acumulado (Sistema 1).
---
...
Essa sensação é psicologicamente análoga ao que os psicólogos chamam de [intolerância à incerteza](https://en.wikipedia.org/wiki/Intolerance_of_uncertainty). Alguns cérebros são programados para lidar com ela com relativa serenidade; outros reagem com uma ansiedade que paralisa o cálculo. [Daniel Kahneman](https://pt.wikipedia.org/wiki/Daniel_Kahneman) formalizou isso na sua teoria dos dois sistemas: dentro da teoria, é o seu Sistema 1 (rápido, intuitivo, automatizado) que assume, apoiado em padrões memorizados. Fora da teoria, é o seu Sistema 2 (lento, consciente, trabalhoso) que precisa fazer todo o serviço. É exaustivo. E esse cansaço repentino pode virar pânico se você não estiver treinado para encará-lo.

### Petrosian e a arte de se sentir em casa no caos

Só existe um jeito saudável de responder a esse medo: treinar deliberadamente no desconforto. [Tigran Petrosian](https://pt.wikipedia.org/wiki/Tigran_Petrosian), Campeão Mundial de 1963 a 1969, era um jogador que sempre parecia à vontade em posições complexas, ambíguas e difíceis de avaliar. Seu estilo, feito de trocas preventivas e de uma defesa profunda, não era covardia. Era a expressão de um domínio psicológico total: ele se sentia mais à vontade em posições levemente inferiores, mas sólidas, do que em posições teoricamente ganhas, mas voláteis. Ele tinha feito as pazes com a incerteza e a usava contra adversários que, esses sim, tinham medo dela.
...
O conceito de [tilt](https://en.wikipedia.org/wiki/Tilt_(poker)), emprestado do pôquer, descreve o estado em que um jogador deixa as emoções ditarem as decisões no lugar da razão. [Antonio Damasio](https://pt.wikipedia.org/wiki/Ant%C3%B3nio_Dam%C3%A1sio), neurocientista da [Universidade do Sul da Califórnia](https://pt.wikipedia.org/wiki/Universidade_do_Sul_da_Calif%C3%B3rnia), mostrou em seus trabalhos sobre os marcadores somáticos que as emoções não são separáveis do processo de decisão: elas fazem parte dele, querendo você ou não. O problema do tilt não é você sentir emoções (isso é humano e inevitável). O problema é que essas emoções tomam a frente da avaliação racional da posição, distorcendo o seu julgamento a cada lance seguinte.
...
- **Dweck, C. S.** [*Mindset: The New Psychology of Success.*](https://pt.wikipedia.org/wiki/Carol_Dweck) Random House, 2006. (A teoria da mentalidade fixa vs. mentalidade de crescimento aplicada ao desempenho.)
- **Csikszentmihalyi, M.** [*Flow: The Psychology of Optimal Experience.*](https://pt.wikipedia.org/wiki/Mih%C3%A1ly_Cs%C3%ADkszentmih%C3%A1lyi) Harper & Row, 1990. (A teoria do flow e suas condições de surgimento em atividades complexas.)
- **Kahneman, D.** [*Thinking, Fast and Slow.*](https://pt.wikipedia.org/wiki/Daniel_Kahneman) Farrar, Straus and Giroux, 2011. (Os sistemas 1 e 2 e suas implicações na tomada de decisão sob pressão.)
- **Damasio, A.** [*Descartes' Error: Emotion, Reason, and the Human Brain.*](https://pt.wikipedia.org/wiki/Ant%C3%B3nio_Dam%C3%A1sio) Putnam, 1994. (O papel dos marcadores somáticos e das emoções na decisão racional.)
...
- **Gelfand, B., & Aagaard, J.** [*Positional Decision Making in Chess.*](https://pt.wikipedia.org/wiki/Boris_Gelfand) Quality Chess, 2015. (A preparação psicológica e a construção de um estilo de jogo coerente.)
