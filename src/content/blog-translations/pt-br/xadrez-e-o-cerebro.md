...
excerpt: >-
  ...
  funções executivas: aqui está o que a pesquisa em neurociência realmente mede no cérebro dos enxadristas.
...
faq:
  - question: O xadrez modifica fisicamente o cérebro?
    answer: >-
      Sim: vários estudos de RM estrutural mostram diferenças de densidade de substância cinzenta e branca nos
      experts em relação aos novatos, nas regiões fronto-parieto-temporais (Hänggi 2014; Trevisan 2022, 29 vs 29).
      Essas mudanças se correlacionam com a idade de início da prática (ρ = −0,54, p < 0,01), o que sugere um efeito
      cumulativo de longo prazo, e não uma predisposição inata.
  - question: O xadrez melhora as funções executivas?
    answer: >-
      Os dados sugerem que sim, mas com efeitos moderados. Um ECR com 26 atletas (Dania 2021, 10 semanas) mostrou
      melhora da memória de trabalho e da atenção seletiva. Um estudo com 65 escolares (Ramos 2017, 30 praticantes
      vs 35 controles) mostrou diferenças significativas em todas as funções executivas medidas (MANOVA). A
      meta-análise de Sala & Gobet (2017) pondera: os efeitos são fracos a moderados e dependem da qualidade do design.
  - question: Quanto tempo é preciso para ver efeitos no cérebro?
    answer: >-
      Os estudos de intervenção usam de 10 a 12 semanas de prática regular para medir efeitos comportamentais. As
      mudanças estruturais (RM) exigem anos de prática intensa. Trevisan 2022 mostra que a DF do opérculo do lobo
      frontal esquerdo se correlaciona com a idade de início (ρ = −0,54), o que sugere que começar cedo amplifica os
      efeitos estruturais.
  - question: O xadrez protege contra o Alzheimer?
    answer: >-
      Não há causalidade comprovada. Verghese et al. (NEJM 2003, n=469, acompanhamento de 5 anos) encontram uma
      associação entre jogos de tabuleiro e −74% de risco de demência. É uma correlação ajustada numa coorte, não um
      ensaio controlado. A revisão sistemática de Williams et al. (2025) confirma as associações estruturais e
      funcionais, mas destaca os limites dos designs observacionais.
  - question: Os benefícios se transferem para outras habilidades?
    answer: >-
      Pouco. Sala & Gobet (2017, meta-análise, 259 citações, Q1 Current Directions in Psychological Science) mostram
      que os efeitos sobre as competências acadêmicas ou cognitivas não enxadrísticas são fracos a moderados, e
      diminuem quando os controles experimentais são mais rigorosos. A transferência se deve mais aos hábitos
      metacognitivos (planejamento, análise) do que a uma transferência direta de habilidades.
---
...
[Magnus Carlsen](https://pt.wikipedia.org/wiki/Magnus_Carlsen) passou por um exame de ressonância em 2015 no âmbito de um projeto de documentário norueguês. Resultado: um cérebro normal, sem arquitetura especial. Nada que distinga um Campeão Mundial de um contador de Bergen.
...
A pesquisa não fixa um limiar universal. As mudanças comportamentais (funções executivas) aparecem após **10 a 12 semanas** de treino regular (Dania 2021; Ramos 2017). As mudanças estruturais (RM) exigem anos de prática intensa e se correlacionam com a idade de início (Trevisan 2022, ρ = −0,54).

### O jogo rápido (Blitz) é tão benéfico quanto o jogo lento?

Não. Os estudos sobre a ativação cerebral mostram que o jogo lento mobiliza mais as áreas de planejamento e de metacognição. O Blitz se apoia principalmente no reconhecimento de padrões já armazenados, útil para o treino tático, mas menos formador para os benefícios cognitivos profundos.

**Depois da leitura:** escolha **uma** seção da tabela dos estudos-chave e guarde **um** número (efeito, n, duração) que você possa citar corretamente da próxima vez que falar de xadrez e cérebro.
...
14. Sala G. & Gobet F. (2017). *Does Far Transfer Exist? Negative Evidence From Chess, Music, and Working Memory Training.* **Current Directions in Psychological Science**. DOI [10.1177/0963721417712760](https://doi.org/10.1177/0963721417712760).
