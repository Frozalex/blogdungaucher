      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "L’objectif reste le même : faire du jeu un lieu où la curiosité intellectuelle rencontre des standards rigoureux — sans transforme les études en autorité morale ni les joueurs en cobayes d’un récit simpliste. Bonne lecture : rigueur d’esprit, humilité de résultat, et toujours un coup suivant à jouer.",
          ],
        },
      ],
      cards: [
