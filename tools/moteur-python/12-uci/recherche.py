...
def chercher(echiquier, budget=None, profondeur_max=PROFONDEUR_MAX,
             bavard=False, quiescence_active=True, rapporter=None):
    ...
    for profondeur in range(1, profondeur_max + 1):
        ...
        if rapporter:
            # Une ligne `info` par itération terminée : c'est ce que
            # l'interface affiche pendant que le moteur réfléchit.
            rapporter(profondeur, score, contexte.noeuds, ecoule, coup)
